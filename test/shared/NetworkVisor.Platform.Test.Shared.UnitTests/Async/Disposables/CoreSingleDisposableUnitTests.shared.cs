...
// ***********************************************************************
// <copyright file="CoreSingleDisposableUnitTests.shared.cs" company="Network Visor">
...
{
    /// <summary>
    /// Class CoreSingleDisposableUnitTests.
    /// Implements the <see cref="CoreTestClassBase" />.
    /// </summary>
    /// <seealso cref="CoreTestClassBase" />
    [PlatformTrait(typeof(CoreSingleDisposableUnitTests))]

    public class CoreSingleDisposableUnitTests : CoreTestCaseBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreSingleDisposableUnitTests"/> class.
        /// </summary>
        /// <param name="testClassFixture">The fixture for the test class, providing shared context for all tests in the class.</param>
        public CoreSingleDisposableUnitTests(CoreTestClassFixture testClassFixture)
