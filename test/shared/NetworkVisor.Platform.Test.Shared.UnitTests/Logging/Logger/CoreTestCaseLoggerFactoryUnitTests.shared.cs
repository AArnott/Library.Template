...
// ***********************************************************************
// <copyright file="CoreTestCaseLoggerFactoryUnitTests.shared.cs" company="Network Visor">
...
{
    /// <summary>
    /// Class CoreTestCaseLoggerFactoryUnitTests.
    /// Implements the <see cref="CoreTestClassBase" />.
    /// </summary>
    /// <seealso cref="CoreTestClassBase" />
    [PlatformTrait(typeof(CoreTestCaseLoggerFactoryUnitTests))]

    public class CoreTestCaseLoggerFactoryUnitTests : CoreTestCaseBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreTestCaseLoggerFactoryUnitTests"/> class.
        /// </summary>
        /// <param name="testClassFixture">The fixture for the test class, providing shared context for all tests in the class.</param>
        public CoreTestCaseLoggerFactoryUnitTests(CoreTestClassFixture testClassFixture)
        ...
        [Fact]
        public void CoreTestCaseLoggerFactoryUnit_ValidateTestClass()
        {
