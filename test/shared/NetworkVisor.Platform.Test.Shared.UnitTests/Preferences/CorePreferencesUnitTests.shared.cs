...
// // ***********************************************************************
// <copyright file="CorePreferencesUnitTests.shared.cs" company="Network Visor">
...
namespace NetworkVisor.Platform.Test.Shared.UnitTests.Preferences
{
    /// <summary>
    /// Class CorePreferencesUnitTests.
    /// </summary>
    [PlatformTrait(typeof(CorePreferencesUnitTests))]

    public class CorePreferencesUnitTests : CoreTestCaseBase
    {
        private bool _isDisposed;

        /// <summary>
        /// Initializes a new instance of the <see cref="CorePreferencesUnitTests"/> class.
        /// </summary>
        /// <param name="testClassFixture">The fixture for the test class, providing shared context for all tests in the class.</param>
        public CorePreferencesUnitTests(CoreTestClassFixture testClassFixture)
