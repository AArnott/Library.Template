...
// ***********************************************************************
// <copyright file="CoreCloudClientIntegrationTests.shared.cs" company="Network Visor">
...
namespace NetworkVisor.Platform.Test.Shared.IntegrationTests.Cloud.Client
{
    /// <summary>
    /// Class CoreCloudClientIntegrationTests.
    /// </summary>
    [PlatformTrait(typeof(CoreCloudClientIntegrationTests))]

    public class CoreCloudClientIntegrationTests : CoreTestCaseBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCloudClientIntegrationTests"/> class.
        /// </summary>
        /// <param name="testClassFixture">The fixture for the test class, providing shared context for all tests in the class.</param>
        public CoreCloudClientIntegrationTests(CoreTestClassFixture testClassFixture)
        ...
        public void Ctor()
        {
            ...
            var cloudClient = new CoreCloudClient(this.TestCaseServiceProvider, this.TestCaseLogger);
