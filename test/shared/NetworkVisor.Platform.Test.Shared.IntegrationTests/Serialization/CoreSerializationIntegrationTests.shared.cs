...
// // ***********************************************************************
// <copyright file="CoreSerializationIntegrationTests.shared.cs" company="Network Visor">
...
{
    /// <summary>
    /// Class CoreSerializationIntegrationTests.
    /// </summary>
    [PlatformTrait(typeof(CoreSerializationIntegrationTests))]

    public class CoreSerializationIntegrationTests : CoreTestCaseBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreSerializationIntegrationTests"/> class.
        /// </summary>
        /// <param name="testClassFixture">The fixture for the test class, providing shared context for all tests in the class.</param>
        public CoreSerializationIntegrationTests(CoreTestClassFixture testClassFixture)
