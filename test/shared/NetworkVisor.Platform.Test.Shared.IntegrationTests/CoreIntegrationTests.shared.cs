...
// ***********************************************************************
// <copyright file="CoreIntegrationTests.shared.cs" company="Network Visor">
...
namespace NetworkVisor.Platform.Test.Shared.IntegrationTests
{
    ...
    public class CoreIntegrationTests : CoreTestCaseBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreIntegrationTests"/> class.
        /// </summary>
        /// <param name="testClassFixture">Class test fixture common across all test cases.</param>
        public CoreIntegrationTests(CoreTestClassFixture testClassFixture)
            : base(testClassFixture)
        {
        }

        [Fact]
        public void CoreIntegration_ValidateTestClass()
        {
        ...
        public void GetTraitOperatingSystem()
        {
            ...
            // Only do OperatingSystem match in CI and not NetCore
