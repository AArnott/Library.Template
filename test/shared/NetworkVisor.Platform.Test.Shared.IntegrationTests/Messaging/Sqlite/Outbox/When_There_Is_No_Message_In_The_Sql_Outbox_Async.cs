...
// // ***********************************************************************
// <copyright file="When_There_Is_No_Message_In_The_Sql_Outbox_Async.cs" company="Network Visor">
...
{
    /// <summary>
    /// Class SqliteOutboxEmptyStoreAsyncTests.
    /// </summary>
    [PlatformTrait(typeof(SqliteOutboxEmptyStoreAsyncTests))]
    public class SqliteOutboxEmptyStoreAsyncTests : CoreSqliteTestCaseBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SqliteOutboxEmptyStoreAsyncTests"/> class.
        /// </summary>
        /// <param name="testClassFixture">
        /// The test class fixture that provides shared context and dependencies for the test class.
        /// </param>
        public SqliteOutboxEmptyStoreAsyncTests(CoreTestClassFixture testClassFixture)
        ...
        public async Task When_There_Is_No_Message_In_The_Sql_Outbox_Async()
        {
            ...
            Assert.Equal(MessageType.MT_NONE, this._storedMessage.Header.MessageType);
        }
    }
}
