...
// // ***********************************************************************
// <copyright file="When_Writing_A_Message_To_A_Binary_Body_Outbox.cs" company="Network Visor">
...
{
    /// <summary>
    /// Class SqliteOutboxWritingBinaryMessageTests.
    /// </summary>
    [PlatformTrait(typeof(SqliteOutboxWritingBinaryMessageTests))]
    public class SqliteOutboxWritingBinaryMessageTests : CoreSqliteTestCaseBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SqliteOutboxWritingBinaryMessageTests"/> class.
        /// </summary>
        /// <param name="testClassFixture">
        /// The test class fixture that provides shared context and dependencies for the test class.
        /// </param>
        public SqliteOutboxWritingBinaryMessageTests(CoreTestClassFixture testClassFixture)
            : base(testClassFixture, true)
        {
            this.SetupMessageDb();
            ...
            byte[] bytes = System.Text.Encoding.UTF8.GetBytes("message body");

            this._messageEarliest = new Paramore.Brighter.Message(messageHeader, new MessageBody(bytes, new ContentType("application/octet-stream"), CharacterEncoding.Raw));
        ...
        public void When_Writing_A_Message_To_The_Outbox()
        {
            ...
            Assert.Equal(this._messageEarliest.Body.Bytes, this._storedMessage.Body.Bytes);
            string bodyAsString = Encoding.UTF8.GetString(this._storedMessage.Body.Bytes);
