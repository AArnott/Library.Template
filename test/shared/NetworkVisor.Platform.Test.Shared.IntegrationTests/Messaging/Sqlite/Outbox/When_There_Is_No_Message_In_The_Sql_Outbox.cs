...
// // ***********************************************************************
// <copyright file="When_There_Is_No_Message_In_The_Sql_Outbox.cs" company="Network Visor">
...
{
    /// <summary>
    /// Class SqliteOutboxEmptyStoreTests.
    /// </summary>
    [PlatformTrait(typeof(SqliteOutboxEmptyStoreTests))]
    public class SqliteOutboxEmptyStoreTests : CoreSqliteTestCaseBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SqliteOutboxEmptyStoreTests"/> class.
        /// </summary>
        /// <param name="testClassFixture">
        /// The test class fixture that provides shared context and dependencies for the test class.
        /// </param>
        public SqliteOutboxEmptyStoreTests(CoreTestClassFixture testClassFixture)
