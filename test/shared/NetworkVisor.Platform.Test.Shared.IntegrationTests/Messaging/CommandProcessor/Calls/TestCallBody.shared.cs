...
// // ***********************************************************************
// <copyright file="TestCallBody.shared.cs" company="Network Visor">
...
namespace NetworkVisor.Platform.MulticastDns.Shared.Test.Requests
{
    ...
    /// </remarks>
    public class TestCallBody : CoreMessageBodyBase<TestCallBody>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestCallBody"/> class with the specified name and optional global logger.
        /// </summary>
        ...
        public TestCallBody(string name, ICoreGlobalLogger? globalLogger = null)
        : base(globalLogger)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestCallBody"/> class with default values.
        /// </summary>
        /// <remarks>
        /// This parameterless constructor sets the <see cref="Name"/> property to an empty string.
        /// It is primarily used for scenarios where a default instance of <see cref="TestCallBody"/> is required.
        /// </remarks>
        public TestCallBody()
        : this(string.Empty)
        {
        ...
        /// It is initialized during the construction of the <see cref="TestCallBody"/> instance
