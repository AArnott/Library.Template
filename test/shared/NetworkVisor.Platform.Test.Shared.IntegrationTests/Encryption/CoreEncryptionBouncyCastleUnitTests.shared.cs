...
namespace NetworkVisor.Platform.Test.Shared.UnitTests.Encryption
{
    ...
    public class CoreEncryptionBouncyCastleUnitTests : CoreTestCaseBase
    {
        ...
        public void EncryptionBouncyCastle_SimpleEncrypt_DefaultKey_EncryptTwice()
        {
            ...
            (string? PlainText, Exception? Exception)? plainTextTestWithException2 = CoreEncryptionBouncyCastle.SimpleDecrypt(encryptedTextWithException2!.Value.EncryptedText!, DefaultKey);
            plainTextTestWithException2.Should().NotBeNull();
            plainTextTestWithException2!.Value.Exception.Should().BeNull();

            this.TestOutputHelper.WriteLine($"2nd Decrypted Text: {plainTextTestWithException2.Value.PlainText}");

            plainTextTestWithException2.Value.PlainText.Should().NotBeNullOrEmpty();
            plainTextTestWithException2.Value.PlainText.Should().Be(PlainText);
        }
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
        ...
        public void EncryptionBouncyCastle_SimpleEncrypt_WithPassword_NonSecretPayload()
        {
            ...
            (string? PlainText, Exception? Exception)? plainTextTestWithException = CoreEncryptionBouncyCastle.SimpleDecryptWithPassword(encryptedTextWithException.Value.EncryptedText!, DefaultPassword, DefaultNonSecretPayload.Length);
            plainTextTestWithException.Should().NotBeNull();
            plainTextTestWithException!.Value.Exception.Should().BeNull();
        ...
        public void EncryptionBouncyCastle_SimpleEncrypt_WithPassword_EncryptTwice()
        {
            ...
            encryptedText2WithException.Should().NotBe(encryptedTextWithException.Value.EncryptedText);
